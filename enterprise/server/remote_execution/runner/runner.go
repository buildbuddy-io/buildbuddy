...
var (
	...
	dockerInheritUserIDs    = flag.Bool("executor.docker_inherit_user_ids", true, "If set, run docker containers using the same uid and gid as the user running the executor process.")
