...
func TestRegistryETLDPlusOne(t *testing.T) {
	tests := []struct {
		...
		{"docker.io/myuser/myimage@sha256:abc123", "docker.io"},
		// GCR
		{"gcr.io/my-project/my-image:latest", "gcr.io"},
		{"gcr.io/my-project/my-image@sha256:abcdef1234567890", "gcr.io"},
	...
	for _, tt := range tests {
		t.Run(tt.imageRef, func(t *testing.T) {
			got := container.RegistryETLDPlusOne(tt.imageRef)
