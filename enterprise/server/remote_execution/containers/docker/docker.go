...
func (r *dockerCommandContainer) Run(ctx context.Context, command *repb.Command, workDir string, creds credentials.Credentials) *interfaces.CommandResult {
...
func (r *dockerCommandContainer) PullImage(ctx context.Context, creds credentials.Credentials) error {
	return PullImage(ctx, r.client, r.image, creds)
}

func PullImage(ctx context.Context, client *dockerclient.Client, image string, creds credentials.Credentials) error {
	if !creds.IsEmpty() {
