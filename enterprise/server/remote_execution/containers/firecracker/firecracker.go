...
var debugExtraKernelArgs = flag.String("executor.firecracker_extra_kernel_args", "", "Extra kernel args.")
...
const (
	...
	workspaceDiskSlackSpaceMB = 20 // 20 MB
...
func (c *FirecrackerContainer) hotSwapWorkspace(ctx context.Context, execClient vmxpb.ExecClient) error {
	...
	log.Debugf("Unmounting workspace.")
	...
	log.Debugf("Unmounted workspace.")
	...
	log.Debugf("Firecracker mounting workspace file...")
	...
	log.Debugf("Firecracker mounted workspace file.")
	return nil
}
...
func (c *FirecrackerContainer) getConfig(ctx context.Context, containerFS, scratchFS, workspaceFS string) (*fcclient.Config, error) {
	bootArgs := "ro console=ttyS0 noapic reboot=k panic=1 pci=off nomodule random.trust_cpu=on i8042.noaux i8042.nomux i8042.nopnp i8042.dumbkbd tsc=reliable ipv6.disable=1"
	var netNS string
	...
	bootArgs = *debugExtraKernelArgs + " " + bootArgs
