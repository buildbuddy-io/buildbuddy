...
var (
	...
	testBazelBuild   = flag.Bool("test_bazel_build", false, "Test workflows (approximately) by cloning a git repo and running a bazel build.")
...
func TestFirecrackerCloneAndBuildBazelRepo(t *testing.T) {
	if !*testBazelBuild {
		t.Skip()
	}
