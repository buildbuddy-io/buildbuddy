...
var (
	...
	workflowsMacComputeUnits      = flag.Int("remote_execution.workflows_mac_compute_units", 2, "Number of BuildBuddy compute units (BCU) to reserve for Mac workflow actions.")
