...
func (s *APIServer) Query(ctx context.Context, req *apipb.QueryRequest) (*apipb.QueryResponse, error) {
	...
	// Also create a marker file with the query result location for easy retrieval
	// markerCmd := "printenv && echo \"hello\" > $BUILDBUDDY_ARTIFACTS_DIRECTORY/hello.txt && cat $BUILDBUDDY_ARTIFACTS_DIRECTORY/hello.txt && echo $BUILDBUDDY_ARTIFACTS_DIRECTORY"
...
func (s *APIServer) waitAndFetchQueryResult(ctx context.Context, invocationID string) (*bqpb.QueryResult, error) {
...
func (s *APIServer) downloadQueryResultFromCAS(ctx context.Context, uri string) (*bqpb.QueryResult, error) {
