...
var (
	...
	patchDigests                = flagutil.StringSlice("patch_digest", "Digests of patches to apply to the repo after checkout. Can be specified multiple times to apply multiple patches.")
