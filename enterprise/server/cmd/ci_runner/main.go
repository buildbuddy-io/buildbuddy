...
func (ar *actionRunner) Run(ctx context.Context, ws *workspace) error {
	...
	if *commitSHA == "" {
		ar.reporter.Printf("WARNING: 'commit_sha' field is missing from ExecuteWorkflow request. Set a 'commit_sha' to ensure there are no race conditions if the remote branch is updated.")
	} else {
