...
func runCASServer(ctx context.Context, env *testenv.TestEnv, t *testing.T) (*grpc.ClientConn, *atomic.Int32, *atomic.Int32) {
...
func TestFindMissingBlobs(t *testing.T) {
	...
	conn, requestCount, _ := runCASServer(ctx, testenv.GetTestEnv(t), t)
...
func TestGetTree(t *testing.T) {
	ctx := context.Background()
	conn, _, requestCounter := runCASServer(ctx, testenv.GetTestEnv(t), t)
	casClient := repb.NewContentAddressableStorageClient(conn)
