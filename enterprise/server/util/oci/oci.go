...
type imageFromRawManifest struct {
	...
	credentials      Credentials
	cacheToken       ociauth.CacheAccessToken
	useCache         bool
	useOCIFetcher    bool
