...
// is returned.
func CreateDiskImage(ctx context.Context, dockerClient *dockerclient.Client, workspaceDir, containerImage string, creds credentials.Credentials) (string, error) {
...
func createExt4Image(ctx context.Context, dockerClient *dockerclient.Client, workspaceDir, containerImage string, creds credentials.Credentials) (string, error) {
	hashedContainerName := hash.String(containerImage)
	containerImagesPath := filepath.Join(workspaceDir, "executor", hashedContainerName)
...
func convertContainerToExt4FS(ctx context.Context, dockerClient *dockerclient.Client, workspaceDir, containerImage string, creds credentials.Credentials) (string, error) {
