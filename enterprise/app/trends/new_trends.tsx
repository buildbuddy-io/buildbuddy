...
export default class NewTrendsComponent extends React.Component<Props, State> {
  ...
  private requestHelper = new TrendsRequestHelper();
      ...
      <div className="trends">
        <div className="container">
          ...
          {selectedTab == TrendsTab.OVERVIEW && (
            <SimpleTrendsTabComponent
              tab={TrendsTab.OVERVIEW}
              search={this.props.search}
              trendsRequestHelper={this.requestHelper}
            />
          )}
          {selectedTab == TrendsTab.BUILDS && (
            <SimpleTrendsTabComponent
              tab={TrendsTab.BUILDS}
              search={this.props.search}
              trendsRequestHelper={this.requestHelper}
            />
          )}
