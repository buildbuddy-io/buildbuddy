...
/** GitHubTooltip renders help text for setting up GitHub integrations. */
  ...
  return (
    <HelpTooltip>
      ...
      <p>
        ...
        <br />
        This generates a user-specific token, so that GitHub can attribute certain requests back to your GitHub user.
        This lets you manage GitHub features in our UI.
      </p>
      <p>
      ...
      <p>
        ...
        <br />
        Even after you've installed the app on the GitHub side, you need to explicitly import the installation to
        BuildBuddy so we're aware that the installation exists.
      </p>
    </HelpTooltip>
  );
}
