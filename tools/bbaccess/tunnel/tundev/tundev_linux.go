...
// the daemon itself runs unprivileged. That is the whole reason for a
// persistent device: an unprivileged process can open it, but cannot create one
// or configure addresses and routes.
