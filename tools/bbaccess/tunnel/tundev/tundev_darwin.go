...
// at install time.
//
// The way out of this is a small privileged helper that creates the utun and
// passes the descriptor to an unprivileged daemon over a unix socket; that is
// worth doing, but it is not needed to make the thing work.
