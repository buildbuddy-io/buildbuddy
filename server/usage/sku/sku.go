...
// service and type.
var (
	BuildEventsBESCount                 = "build_events.build_event_stream.count"
	RemoteCacheCASHits                  = "remote_cache.content_addressable_storage.hits"
	RemoteCacheCASDownloadedBytes       = "remote_cache.content_addressable_storage.downloaded_bytes"
	RemoteCacheACHits                   = "remote_cache.action_cache_hits.hits"
	RemoteCacheACCachedExecDurationUsec = "remote_cache.action_cache.cached_execution_duration_usec"
	RemoteExecutionExecutorDurationUsec = "remote_execution.execute.duration_usec"
	RemoteExecutionExecutorCPUNanos     = "remote_execution.execute.cpu_nanos"
	RemoteExecutionExecutorMemoryGBUsec = "remote_execution.execute.memory_gb_usec"
)
