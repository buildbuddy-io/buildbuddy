...
func init() {
	headerContextKeys = map[string]string{
		...
		"x-buildbuddy-container-registry-username":            "x-buildbuddy-container-registry-username",
		"x-buildbuddy-container-registry-password":            "x-buildbuddy-container-registry-password",
