...
type RealEnv struct {
	...
	atimeUpdaters                        []interfaces.DigestOperator
...
func (r *RealEnv) AddAtimeUpdater(updater interfaces.DigestOperator) {
	r.atimeUpdaters = append(r.atimeUpdaters, updater)
}

func (r *RealEnv) GetAtimeUpdaters() []interfaces.DigestOperator {
	return r.atimeUpdaters
}
