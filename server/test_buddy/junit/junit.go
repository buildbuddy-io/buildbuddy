...
func (p *parser) parseCase(decoder *xml.Decoder, start xml.StartElement, startDepth int) (*Case, []Diagnostic, error) {
...
func (p *parser) caseRecord(index int, state *caseState) (*Case, []Diagnostic, error) {
	if state.name == "" {
