...
func TestAllowedRPCs(t *testing.T) {
	for _, test := range []struct {
		...
		{
			Name:         "CacheWriteRPC_API_Run_NoCacheCapabilities_NotAllowed",
			RPC:          apiServicePrefix + "Run",
			Capabilities: []cappb.Capability{},
			Allowed:      false,
		},
		{
			Name:         "CacheWriteRPC_API_Run_CASWrite_Allowed",
			RPC:          apiServicePrefix + "Run",
			Capabilities: []cappb.Capability{cappb.Capability_CAS_WRITE},
			Allowed:      true,
		},
		{
			Name:         "CacheWriteRPC_API_Run_CACHEWrite_Allowed",
			RPC:          apiServicePrefix + "Run",
			Capabilities: []cappb.Capability{cappb.Capability_CACHE_WRITE},
			Allowed:      true,
		},
		{
			Name:      "CacheWriteRPC_API_Run_Anonymous_NotAllowed",
			RPC:       apiServicePrefix + "Run",
			Anonymous: true,
			Allowed:   false,
		},
		{
			Name:         "CacheWriteRPC_API_ExecuteWorkflow_NoCacheCapabilities_NotAllowed",
			RPC:          apiServicePrefix + "ExecuteWorkflow",
			Capabilities: []cappb.Capability{},
			Allowed:      false,
		},
		{
			Name:         "CacheWriteRPC_API_ExecuteWorkflow_CASWrite_Allowed",
			RPC:          apiServicePrefix + "ExecuteWorkflow",
			Capabilities: []cappb.Capability{cappb.Capability_CAS_WRITE},
			Allowed:      true,
		},
		{
			Name:         "CacheWriteRPC_API_ExecuteWorkflow_CACHEWrite_Allowed",
			RPC:          apiServicePrefix + "ExecuteWorkflow",
			Capabilities: []cappb.Capability{cappb.Capability_CACHE_WRITE},
			Allowed:      true,
		},
		{
			Name:         "CacheWriteRPC_BuildBuddy_Run_NoCacheCapabilities_NotAllowed",
			RPC:          buildBuddyServicePrefix + "Run",
			Capabilities: []cappb.Capability{},
			Allowed:      false,
		},
		{
			Name:         "CacheWriteRPC_BuildBuddy_Run_CASWrite_Allowed",
			RPC:          buildBuddyServicePrefix + "Run",
			Capabilities: []cappb.Capability{cappb.Capability_CAS_WRITE},
			Allowed:      true,
		},
		{
			Name:         "CacheWriteRPC_BuildBuddy_Run_CACHEWrite_Allowed",
			RPC:          buildBuddyServicePrefix + "Run",
			Capabilities: []cappb.Capability{cappb.Capability_CACHE_WRITE},
			Allowed:      true,
		},
		{
			Name:         "CacheWriteRPC_BuildBuddy_ExecuteWorkflow_NoCacheCapabilities_NotAllowed",
			RPC:          buildBuddyServicePrefix + "ExecuteWorkflow",
			Capabilities: []cappb.Capability{},
			Allowed:      false,
		},
		{
			Name:         "CacheWriteRPC_BuildBuddy_ExecuteWorkflow_CASWrite_Allowed",
			RPC:          buildBuddyServicePrefix + "ExecuteWorkflow",
			Capabilities: []cappb.Capability{cappb.Capability_CAS_WRITE},
			Allowed:      true,
		},
		{
			Name:         "CacheWriteRPC_BuildBuddy_ExecuteWorkflow_CACHEWrite_Allowed",
			RPC:          buildBuddyServicePrefix + "ExecuteWorkflow",
			Capabilities: []cappb.Capability{cappb.Capability_CACHE_WRITE},
			Allowed:      true,
		},
