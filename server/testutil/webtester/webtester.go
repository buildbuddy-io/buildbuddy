...
var (
	...
	debug               = flag.Bool("webdriver_debug", false, "Enable debug mode for webdriver tests: show a browser window and keep it open at the end of the test.")
	...
	verbose             = flag.Bool("webdriver_verbose", false, "Show verbose logs from the browser. Useful for debugging browser crashes.")
