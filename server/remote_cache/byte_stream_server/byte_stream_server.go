...
const (
	...
	// cache. Benchmarks show that 256KiB or 512KiB perform similarly. Values
	// smaller than 256KiB or larger than 1MiB are both slower and allocate more
	// bytes.
	readBufSizeBytes = 512 * 1024
)
