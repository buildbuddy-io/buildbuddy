...
import (
	...
	"github.com/buildbuddy-io/buildbuddy/v2/server/build_event_protocol/event_index"
	...
	"github.com/buildbuddy-io/buildbuddy/v2/server/endpoint_urls/cache_api_url"
	"github.com/buildbuddy-io/buildbuddy/v2/server/endpoint_urls/events_api_url"
	"github.com/buildbuddy-io/buildbuddy/v2/server/endpoint_urls/remote_exec_api_url"
	...
	"github.com/buildbuddy-io/buildbuddy/v2/server/remote_cache/directory_size"
	"github.com/buildbuddy-io/buildbuddy/v2/server/remote_cache/scorecard"
	"github.com/buildbuddy-io/buildbuddy/v2/server/tables"
	"github.com/buildbuddy-io/buildbuddy/v2/server/target"
	...
	bzpb "github.com/buildbuddy-io/buildbuddy/v2/proto/bazel_config"
	...
	irpb "github.com/buildbuddy-io/buildbuddy/v2/proto/iprules"
	qpb "github.com/buildbuddy-io/buildbuddy/v2/proto/quota"
	repb "github.com/buildbuddy-io/buildbuddy/v2/proto/repo"
	...
	stpb "github.com/buildbuddy-io/buildbuddy/v2/proto/stats"
	...
	wspb "github.com/buildbuddy-io/buildbuddy/v2/proto/workspace"
