...
// Both OSS and enterprise main must call this before StartAndRunServices.
// Enterprise main calls it early so that services registered afterward
// (e.g. ocifetcher) can depend on the local gRPC clients.
