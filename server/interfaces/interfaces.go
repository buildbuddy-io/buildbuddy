...
type HitTrackerFactory interface {
	...
	NewACHitTracker(ctx context.Context, invocationID string, requestMetadata *repb.RequestMetadata) HitTracker

	// Creates a new HitTracker for tracking ByteStream/CAS hits.
	NewCASHitTracker(ctx context.Context, invocationID string, requestMetadata *repb.RequestMetadata) HitTracker
}
