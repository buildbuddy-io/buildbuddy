...
// Stdio is an alias for commandtypes.Stdio, kept here for backward
// compatibility.
type Stdio = commandtypes.Stdio

// CommandResult is an alias for commandtypes.CommandResult, kept here for
// backward compatibility.
type CommandResult = commandtypes.CommandResult
