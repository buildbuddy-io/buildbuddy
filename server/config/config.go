...
type ExecutorConfig struct {
	...
	DefaultIsolationType          string                    `yaml:"default_isolation_type" usage:"The default workload isolation type when no type is specified in an action. If not set,we use the first of the following that is set: docker, firecracker, podman, barerunner"`
