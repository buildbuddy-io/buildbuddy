...
// element, and returns a new slice with the elements shuffled according to
// their weights.
//
...
// Find(6)  returns 0 since prefixSum(0) = 0  (<= 6)  but prefixSum(1) =  7 (> 6)
// Find(7)  returns 1 since prefixSum(1) = 7  (<= 7)  but prefixSum(2) = 18 (> 7)
// Find(8)  returns 1 since prefixSum(1) = 7  (<= 8)  but prefixSum(2) = 18 (> 8)
// Find(18) returns 2 since prefixSum(2) = 18 (<= 18) but 3 >= len(t)
