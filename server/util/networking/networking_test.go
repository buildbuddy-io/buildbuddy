...
const (
	// Set this to true to enable packet capture for debugging.
...
func TestNetworkStats(t *testing.T) {
	...
	server := httptest.NewUnstartedServer(trafficTestHandler(t))
	...
	getPool := func(ctx context.Context, t *testing.T) *networking.ContainerNetworkPool {
		pool := networking.NewContainerNetworkPool(32 /*=poolSize*/)
		t.Cleanup(func() {
...
// of the same size.
func trafficTestHandler(t *testing.T) http.HandlerFunc {
