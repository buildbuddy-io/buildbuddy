...
var (
	...
	executionGraphsEnabled                 = flag.Bool("app.execution_graphs_enabled", true, "Shows a bunch of information using debug execution graph output")
...
func serveIndexTemplate(ctx context.Context, env environment.Env, tpl *template.Template, version, jsPath, stylePath string, w http.ResponseWriter) {
	config := cfgpb.FrontendConfig{
		...
		ExecutionGraphsEnabled:                 *executionGraphsEnabled,
	}
