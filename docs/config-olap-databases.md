...
However, some UI features, such as Trends, Drilldown, Test Grid, Tags filtering, and Audit Logging, may require ClickHouse. An example of how to use Trends and Drilldown can be found at [this blog post](https://github.com/buildbuddy-io/buildbuddy-internal/issues/6611).
