...
```bash
echo "$(echo "buildbuddy-io/5.0.4"; cat .bazelversion)" > .bazelversion
```

This will simply prepend `buildbuddy-io/5.0.4` on a new line above your `.bazelversion` file like so:
