...
```bash
echo "$(echo "buildbuddy-io/5.0.1"; cat .bazelversion)" > .bazelversion
```

This will simply prepend `buildbuddy-io/5.0.1` on a new line above your `.bazelversion` file like so:
