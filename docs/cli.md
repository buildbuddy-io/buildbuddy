...
```bash
echo "$(echo "buildbuddy-io/0.1.3"; cat .bazelversion)" > .bazelversion
```

This will simply prepend `buildbuddy-io/0.1.3` on a new line above your `.bazelversion` file like so:
