...
```bash
echo "$(echo "buildbuddy-io/0.0.15"; cat .bazelversion)" > .bazelversion
```

This will simply prepend `buildbuddy-io/0.0.15` on a new line above your `.bazelversion` file like so:

```title=".bazelversion"
buildbuddy-io/0.0.15
5.3.2
```
