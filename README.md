...
If you'd like to host your own instance **on-prem** or in the cloud, check out our [documentation](https://buildbuddy.io/docs/introduction).

# Documentation

Our [documentation](https://buildbuddy.io/docs/introduction) gives you a full look at how to set up and configure BuildBuddy.
