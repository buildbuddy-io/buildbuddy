...
export const GENERIC_FILTER_PARAM_NAME = "sq";
...
export const GLOBAL_FILTER_PARAM_NAMES: readonly string[] = [
  ROLE_PARAM_NAME,
  STATUS_PARAM_NAME,
...
export const GLOBAL_SORT_PARAM_NAMES: readonly string[] = [SORT_BY_PARAM_NAME, SORT_ORDER_PARAM_NAME];

export const PERSISTENT_URL_PARAMS: readonly string[] = [...GLOBAL_FILTER_PARAM_NAMES, ...GLOBAL_SORT_PARAM_NAMES];
