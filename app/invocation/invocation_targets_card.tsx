            ...
            {events
              ...
              .map((target) => (
                ...
                >
                  <div
                    title={`${
                      this.props.model.configuredMap.get(target.id.targetCompleted.label)
                        ?.buildEvent.configured.targetKind
                    } ${this.props.model.getTestSize(
                      this.props.model.configuredMap.get(target.id.targetCompleted.label)
                        ?.buildEvent.configured.testSize
                    )}`}
                    className="clickable target"
                  >
                    <img className="target-status-icon" src={this.props.iconPath} />{" "}
