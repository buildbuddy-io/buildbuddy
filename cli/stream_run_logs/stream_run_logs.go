...
func Configure(args *parser.BazelArgs, besBackend string) (*parser.BazelArgs, *Opts, error) {
...
func parseFlags(args *parser.BazelArgs) (enabled bool, onFailure FailureMode, err error) {
