...
replace (
	...
	github.com/googleapis/go-gorm-spanner => github.com/JonathanPerry651/go-gorm-spanner v0.0.0-20241010132806-48169dd53bb6
)
...
require (
	...
	github.com/googleapis/go-gorm-spanner v1.3.0 // indirect
