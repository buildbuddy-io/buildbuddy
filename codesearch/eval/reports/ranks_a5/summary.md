...
|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 32% | 72% | 0.50 | 80% | 96% | 0.88 | 0.33 | 64% |
| keyword | 20 | 20 | 45% | 95% | 0.64 | 70% | 90% | 0.78 | 0.44 | 80% |
| phrase | 15 | 15 | 60% | 80% | 0.67 | 40% | 80% | 0.57 | 0.33 | 67% |
| regex | 15 | 6 | 0% | 50% | 0.20 | 50% | 83% | 0.62 | 0.17 | 40% |
| filter | 10 | 5 | 20% | 40% | 0.31 | 60% | 100% | 0.80 | 0.39 | 50% |
| ranking | 15 | 0 | - | - | - | - | - | - | 0.14 | 40% |
| **total** | 100 | 71 | 38% | 76% | 0.54 | 65% | 90% | 0.76 | 0.31 | 59% |

## Queries where we miss the target but Google finds it

- `func Fprintf` (sym-fprintf): local rank 40, google rank 1, target src/fmt/print.go
...
- `LittleEndian` (sym-littleendian): local rank 17, google rank 3, target src/encoding/binary/binary.go
- `stopTheWorld` (sym-stoptheworld): local rank 8, google rank 1, target src/runtime/proc.go
- `QuoteMeta` (sym-quotemeta): local rank 26, google rank 1, target src/regexp/regexp.go
...
- `EOF = errors\.New` (re-eof-error): local rank 13, google rank 1, target src/io/io.go
...
- `file:json decode` (flt-json-decode): local rank 10, google rank 2, target src/encoding/json/decode.go
