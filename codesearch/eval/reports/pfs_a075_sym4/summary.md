...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 80% | 96% | 0.87 | 80% | 96% | 0.88 | 40% | 72% | 0.53 | 0.35 | 88% |
| keyword | 20 | 20 | 65% | 85% | 0.74 | 70% | 90% | 0.78 | 50% | 90% | 0.67 | 0.57 | 90% |
| phrase | 15 | 15 | 20% | 67% | 0.40 | 40% | 80% | 0.57 | 53% | 87% | 0.66 | 0.26 | 47% |
| regex | 15 | 6 | 17% | 50% | 0.37 | 50% | 83% | 0.62 | 0% | 50% | 0.23 | 0.12 | 20% |
| filter | 10 | 5 | 60% | 80% | 0.69 | 60% | 100% | 0.80 | 40% | 60% | 0.45 | 0.49 | 80% |
| ranking | 15 | 0 | - | - | - | - | - | - | - | - | - | 0.30 | 60% |
| **total** | 100 | 71 | 56% | 82% | 0.68 | 65% | 90% | 0.76 | 42% | 77% | 0.57 | 0.35 | 67% |

## Queries where we miss the target but Google finds it

- `goroutine stack grow` (kw-goroutine-stack-grow): local rank 10, google rank 3, target src/runtime/stack.go
