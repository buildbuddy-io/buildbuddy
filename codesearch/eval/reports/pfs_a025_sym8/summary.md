...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 56% | 96% | 0.73 | 80% | 96% | 0.88 | 40% | 72% | 0.53 | 0.34 | 92% |
| keyword | 20 | 20 | 55% | 85% | 0.67 | 70% | 90% | 0.78 | 50% | 90% | 0.67 | 0.61 | 95% |
| phrase | 15 | 15 | 20% | 67% | 0.40 | 40% | 80% | 0.57 | 53% | 87% | 0.66 | 0.26 | 47% |
| regex | 15 | 6 | 17% | 33% | 0.28 | 50% | 83% | 0.62 | 0% | 50% | 0.23 | 0.11 | 20% |
| filter | 10 | 5 | 60% | 80% | 0.68 | 60% | 100% | 0.80 | 40% | 60% | 0.45 | 0.50 | 80% |
| ranking | 15 | 0 | - | - | - | - | - | - | - | - | - | 0.30 | 60% |
| **total** | 100 | 71 | 45% | 80% | 0.60 | 65% | 90% | 0.76 | 42% | 77% | 0.57 | 0.36 | 69% |

## Queries where we miss the target but Google finds it

- `goroutine stack grow` (kw-goroutine-stack-grow): local rank 11, google rank 3, target src/runtime/stack.go
...
- `case:yes Printf` (flt-case-printf): local rank 13, google rank 2, target src/fmt/print.go
