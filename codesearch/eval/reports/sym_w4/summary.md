...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 36% | 68% | 0.49 | 80% | 96% | 0.88 | 40% | 72% | 0.53 | 0.35 | 60% |
...
- `Goexit` (sym-goexit): local rank 23, google rank 1, target src/runtime/panic.go
...
- `EOF = errors\.New` (re-eof-error): local rank 16, google rank 1, target src/io/io.go
