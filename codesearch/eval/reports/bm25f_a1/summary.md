...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 32% | 88% | 0.53 | 80% | 96% | 0.88 | 40% | 72% | 0.53 | 0.20 | 80% |
...
| ranking | 15 | 0 | - | - | - | - | - | - | - | - | - | 0.03 | 7% |
| **total** | 100 | 71 | 30% | 72% | 0.47 | 65% | 90% | 0.76 | 42% | 77% | 0.57 | 0.21 | 44% |
...
- `func Pipe` (sym-pipe): local rank 14, google rank 2, target src/io/pipe.go
...
- `http client redirect` (kw-http-client-redirect): local rank 10, google rank 1, target src/net/http/client.go
