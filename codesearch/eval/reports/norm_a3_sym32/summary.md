...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 32% | 84% | 0.52 | 80% | 96% | 0.88 | 40% | 72% | 0.53 | 0.20 | 76% |
| keyword | 20 | 20 | 15% | 50% | 0.33 | 70% | 90% | 0.78 | 50% | 90% | 0.67 | 0.29 | 35% |
| phrase | 15 | 15 | 20% | 67% | 0.40 | 40% | 80% | 0.57 | 53% | 87% | 0.66 | 0.26 | 47% |
| regex | 15 | 6 | 50% | 67% | 0.57 | 50% | 83% | 0.62 | 0% | 50% | 0.23 | 0.09 | 13% |
| filter | 10 | 5 | 60% | 100% | 0.75 | 60% | 100% | 0.80 | 40% | 60% | 0.45 | 0.43 | 60% |
| ranking | 15 | 0 | - | - | - | - | - | - | - | - | - | 0.03 | 0% |
| **total** | 100 | 71 | 28% | 70% | 0.46 | 65% | 90% | 0.76 | 42% | 77% | 0.57 | 0.21 | 41% |

## Queries where we miss the target but Google finds it

- `QuoteMeta` (sym-quotemeta): local rank 44, google rank 1, target src/regexp/regexp.go
- `func Pipe` (sym-pipe): local rank 23, google rank 2, target src/io/pipe.go
- `func NewRequest` (sym-newrequest): local rank 6, google rank 1, target src/net/http/request.go
...
- `utf8 decode rune` (kw-utf8-decode-rune): local rank 20, google rank 1, target src/unicode/utf8/utf8.go
- `mutex starvation` (kw-mutex-starvation): local rank 6, google rank 1, target src/sync/mutex.go
- `http client redirect` (kw-http-client-redirect): local rank 11, google rank 1, target src/net/http/client.go
