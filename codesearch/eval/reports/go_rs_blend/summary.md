...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 80% | 96% | 0.88 | 80% | 96% | 0.88 | 76% | 92% | 0.84 | 0.41 | 88% |
| keyword | 20 | 20 | 65% | 85% | 0.74 | 70% | 90% | 0.78 | 55% | 90% | 0.70 | 0.58 | 95% |
| phrase | 15 | 15 | 73% | 93% | 0.82 | 40% | 80% | 0.57 | 80% | 93% | 0.85 | 0.93 | 93% |
| regex | 15 | 6 | 17% | 50% | 0.37 | 50% | 83% | 0.62 | 50% | 50% | 0.54 | 0.16 | 33% |
| filter | 10 | 5 | 60% | 100% | 0.71 | 60% | 100% | 0.80 | 60% | 100% | 0.77 | 0.80 | 90% |
| ranking | 15 | 0 | - | - | - | - | - | - | - | - | - | 0.34 | 67% |
| **total** | 100 | 71 | 68% | 89% | 0.77 | 65% | 90% | 0.76 | 68% | 89% | 0.77 | 0.51 | 79% |

## Queries where we miss the target but Google finds it

- `func (Fpr|Spr)intf` (re-fprintf-sprintf): local rank 26, google rank 4, target src/fmt/print.go
