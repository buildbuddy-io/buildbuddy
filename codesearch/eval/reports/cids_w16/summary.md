...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| symbol | 25 | 25 | 20% | 64% | 0.39 | 80% | 96% | 0.88 | 40% | 72% | 0.53 | 0.34 | 56% |
| keyword | 20 | 20 | 45% | 90% | 0.61 | 70% | 90% | 0.78 | 50% | 90% | 0.67 | 0.42 | 75% |
| phrase | 15 | 15 | 60% | 80% | 0.66 | 40% | 80% | 0.57 | 53% | 87% | 0.66 | 0.33 | 60% |
| regex | 15 | 6 | 0% | 33% | 0.17 | 50% | 83% | 0.62 | 0% | 50% | 0.23 | 0.18 | 47% |
| filter | 10 | 5 | 20% | 40% | 0.30 | 60% | 100% | 0.80 | 40% | 60% | 0.45 | 0.37 | 40% |
| ranking | 15 | 0 | - | - | - | - | - | - | - | - | - | 0.12 | 27% |
| **total** | 100 | 71 | 34% | 70% | 0.49 | 65% | 90% | 0.76 | 42% | 77% | 0.57 | 0.30 | 53% |
...
- `NewScanner` (sym-newscanner): local rank 8, google rank 1, target src/bufio/scan.go
...
- `func (Fpr|Spr)intf` (re-fprintf-sprintf): local rank 24, google rank 4, target src/fmt/print.go
...
- `file:json decode` (flt-json-decode): local rank 17, google rank 2, target src/encoding/json/decode.go
