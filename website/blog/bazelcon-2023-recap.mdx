...
- [Maggie](https://www.linkedin.com/in/maggie-lou-4a3bb110a) explained how we're [using user fault file descriptors (UFFD) to support microVM snapshot sharing](https://youtu.be/8Dc8R_Zrf6M?t=16010) in workflows, keeping workflow runner Bazel analysis caches hot, and speeding up workflows by up to 8x.
