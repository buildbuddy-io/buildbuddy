...
<Image img={require("../../static/img/soc2.jpg")} style={{ float: "right", padding: "0 24px" }} />
...
When it comes to XHRF/CSRF attacks - we use SameSite cookies to mitigate this attack vector.
