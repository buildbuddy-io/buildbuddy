    ...
    <Layout title="BuildBuddy CLI">
      <div className={common.page}>
        ...
        <Hero
            ...
            <Terminal
              ...
              states={[
                ...
                <>
                  <div>
                    <Prompt />
                    <span>{`bb install buildbuddy-io/plugins@v0.0.12 open_invocation`}</span>
                  </div>
                </>,
                <>
                  <div>
          ...
          lessPadding={true}
          flipped={false}
          snippet={`bb install buildbuddy-io/plugins@v0.0.12 open_invocation`}
        ...
        <Hero
            ...
            <Terminal
              ...
              states={[
                ...
                <>
                  <div>
                    <Prompt />
                    <span>{`echo "$(echo "buildbuddy-io/0.0.11"; cat .bazelversion)" > .bazelversion`}</span>
                  </div>
                </>,
                <>
                  <div>
          ...
          lessPadding={true}
          flipped={false}
          snippet={`echo "$(echo "buildbuddy-io/0.0.11"; cat .bazelversion)" > .bazelversion`}
          primaryButtonText=""
          secondaryButtonText=""
        />
